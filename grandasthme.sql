...
INSERT INTO `banque` VALUES (1,500);
...
INSERT INTO `departement` VALUES (1,'Bas-Rhin','basRhin',67,0,0),(2,'Haut-Rhin','hautRhin',68,0,0),(3,'Moselle','moselle',57,0,0),(4,'Ardennes','ardennes',8,0,0),(5,'Aube','aube',10,0,0),(6,'Meurthe-et-Moselle','meurtheEtMoselle',54,0,0),(7,'Vosges','vosges',88,0,0),(8,'Marne','marne',51,0,0),(9,'Haute-Marne','hauteMarne',52,0,0),(10,'Meuse','meuse',55,0,0);
...
INSERT INTO `developpement` VALUES (1,1,'Indemnisation des Frais Kilomètriques du Personnel','Encouragez vos employés à utiliser leur véhicule personnel et économisez sur l\'assurance et l\'entretien d\'une flotte automobile. (Effet Permanent: x2 de gains par tour)',5,0.05,1.2,1.2),(2,1,'Export International Routier','Faites des économies sur le transport de vos marchandises à l\'international. (Effet Permanent: x3 de gains par tour) ',250,1.5,5,3),(3,1,'Yet\'s Jet Loss','Achetez un Jet pour les déplacements de votre Conseil d\'Administration (Effet Permanent: x1,5 de gains par tour)',2000,0.5,1.5,1.5),(4,2,'Incinération','Pourquoi trier ses déchêts? Autant tout brûler! (Effet Permanent: x1,2 de gains par tour)',50,3,1.1,1.3),(5,2,'Pourquoi Filter?','Rejetez vos polluants dans l\'air directement depuis les cheminées. (Effet Permanent: x2 de gains par tour)',8,3,1.001,2),(6,2,'Climatisation/Chauffage des Installations','Offrez à vos employés confort et bien-être (Effet Permanent: x1.3 de gains par tour)',60,2,1.4,1.3),(7,3,'Agriculture Intensive','Un maximum de production dans un minimum d\'espace (Effet Permanent: x3 de gains par tour)',500,4,1.3,2),(8,3,'Pesticides et Engrais','Protégez vos récoltes et maximisez le rendement (Effet Permanent: x3 de gains par tour)',170,3,1.5,3),(9,3,'Elevage Industriel','Jouez à Tetris avec les animaux (Effet Permanent: x2 de gains par tour)',700,3.5,2,4);
...
INSERT INTO `facteur_inflation_global` VALUES (1,1);
...
INSERT INTO `niveau_pollution_global` VALUES (1,1);
...
-- Dump completed on 2018-07-12 17:44:13
=======
  `facteur_gain` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
